...
curl -L https://sourceforge.net/projects/luabinaries/files/5.3.5/Windows%20Libraries/Static/lua-5.3.5_Win32_bin.zip/download -o lua.zip
...
mkdir C:\Lua53
move lua-5.3.5_Win32_bin\* C:\Lua53\
